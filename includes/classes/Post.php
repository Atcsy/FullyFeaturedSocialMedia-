...
class Post
{
    ...
    public function submitPost($body, $user_to)
    {
        ...
        if($check_empty != "") {
            ...
            $sql = "INSERT INTO posts
                (body, added_by, user_to, date_added, user_closed, deleted, likes)
                VALUES
    ...
    public function loadPostsFriends($data, $limit)
    {
        ...
        if(mysqli_num_rows($data_query) > 0) {  //have result
            $num_iterations = 0; // nubmer of results checked (not necasserly posted)
            $count = 1;
            ...
            while($row = mysqli_fetch_array($data_query)) {
                ...
                if($user_logged_obj->isFriend($added_by)) {
                    ...
                    if($num_iterations++ < $start)
                        ...
                        //once 10 posts have benn loaded , break
                    if($count > $limit) {
                        break;
                    } else {
                        $count++;
                ...
                <script>
                    $(document).ready(function(){
                        $('#post<?php echo $id; ?>').on('click', function(){
                            bootbox.confirm("Are you sur you want to delete this post?", function(result){
