...
class Message
{
	...
	public function sendMessage($user_to, $body, $date)
	{
		if($body != "") {
			...
			$sql = "INSERT INTO messages
                (user_to, user_from, body, date, opened, viewed, deleted)
                VALUES
	...
	public function getMessages($otherUser)
	{
		...
		$get_messages_query = mysqli_query($this->con, "SELECT * FROM messages WHERE
			(user_to='$userLoggedIn' AND user_from='$otherUser') OR (user_from='$userLoggedIn' AND user_to='$otherUser')");
